...
describe('Clase Character', () => {
    ...
    let invention: Invention = new Invention("I-001", "Portal Gun", character, "Gadget", 8, "A device that allows the user to travel between dimensions");
    ...
    describe('Error al introducir dangerLevel', () => {
        test('Debería lanzar un error si el nivel de peligro es menor a 1', () => {
            expect(() => new Invention("I-001", "Portal Gun", character, "Gadget", -4, "A device that allows the user to travel between dimensions")).toThrow("El nivel de peligro debe de estar en el rango [1-10]");
        });

        test('Debería lanzar un error si el nivel de peligro es mayor a 10', () => {
            expect(() => new Invention("I-001", "Portal Gun", character, "Gadget", 84, "A device that allows the user to travel between dimensions")).toThrow("El nivel de peligro debe de estar en el rango [1-10]");
        });
    });
});